...
<div className="w-70 ml-127 mb-135 mt-[-230px] bg-gray-700 text-center hover:scale-100 hover:shadow-2xl hover:shadow-purple-500">
...
<div className="w-70 ml-230 mb-150 mt-[-900px] bg-gray-700 text-center hover:scale-100 hover:shadow-2xl hover:shadow-purple-500">
